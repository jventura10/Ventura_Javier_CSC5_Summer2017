...
int main(int argc, char** argv) {
    //Declare variables
    short nQts,nDms,nNks; //Number of Quarters,Dimes and Nickels Range [0,32767]
    ...
    cout<<"Input the number of Quarters, Dimes, and Nickels you have."<<endl;
    cout<<"Inputs are limited to 32467 coins apiece";
